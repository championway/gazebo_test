...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/david/gazebo_test/catkin_ws/src/description)
  set(urdf_DEVEL_PREFIX /home/david/gazebo_test/catkin_ws/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/david/gazebo_test/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'david <david@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/david/gazebo_test/catkin_ws/src/description/${idir}'.  Ask the maintainer 'david <david@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/david/gazebo_test/catkin_ws/devel/lib;/home/david/gazebo_test/catkin_ws/devel/lib;/home/david/duckietown/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
