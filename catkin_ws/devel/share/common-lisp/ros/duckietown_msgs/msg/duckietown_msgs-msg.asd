...
(defsystem "duckietown_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "PatrolBot" :depends-on ("_package_PatrolBot"))
    (:file "_package_PatrolBot" :depends-on ("_package"))
    ...
    (:file "RobotList" :depends-on ("_package_RobotList"))
    (:file "_package_RobotList" :depends-on ("_package"))
    (:file "RobotName" :depends-on ("_package_RobotName"))
    (:file "_package_RobotName" :depends-on ("_package"))
