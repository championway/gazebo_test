...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Segment>)))
  ...
  "bdd557116564dd7115fda92ac2cef95c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Segment)))
  "Returns md5sum for a message object of type 'Segment"
  "bdd557116564dd7115fda92ac2cef95c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Segment>)))
  ...
  (cl:format cl:nil "uint8 WHITE=0~%uint8 YELLOW=1	~%uint8 RED=2~%uint8 BLUE=3~%uint8 color~%duckietown_msgs/Vector2D[2] pixels_normalized~%duckietown_msgs/Vector2D normal~%~%geometry_msgs/Point[2] points~%~%================================================================================~%MSG: duckietown_msgs/Vector2D~%float32 x~%float32 y~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Segment)))
  "Returns full string definition for message of type 'Segment"
  (cl:format cl:nil "uint8 WHITE=0~%uint8 YELLOW=1	~%uint8 RED=2~%uint8 BLUE=3~%uint8 color~%duckietown_msgs/Vector2D[2] pixels_normalized~%duckietown_msgs/Vector2D normal~%~%geometry_msgs/Point[2] points~%~%================================================================================~%MSG: duckietown_msgs/Vector2D~%float32 x~%float32 y~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
