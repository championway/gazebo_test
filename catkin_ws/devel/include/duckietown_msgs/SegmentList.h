...
struct SegmentList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::duckietown_msgs::Segment_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::duckietown_msgs::Segment_<ContainerAllocator> >::other >  _segments_type;
...
struct MD5Sum< ::duckietown_msgs::SegmentList_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc03b3a871148cba0ULL;
  static const uint64_t static_value2 = 0x7e59d10b480044b7ULL;
};
