...
struct ObstacleImageDetectionList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::duckietown_msgs::ObstacleImageDetection_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::duckietown_msgs::ObstacleImageDetection_<ContainerAllocator> >::other >  _list_type;
  _list_type list;
