...
struct TagInfo_
{
  ...
  _location_type location;
    ...
    enum { S_NAME = 0u };
     ...
     enum { STOP = 5u };
     enum { YIELD = 6u };
     enum { NO_RIGHT_TURN = 7u };
     enum { NO_LEFT_TURN = 8u };
     enum { ONEWAY_RIGHT = 9u };
     enum { ONEWAY_LEFT = 10u };
     enum { FOUR_WAY = 11u };
     enum { RIGHT_T_INTERSECT = 12u };
     enum { LEFT_T_INTERSECT = 13u };
     enum { T_INTERSECTION = 14u };
     enum { DO_NOT_ENTER = 15u };
     enum { PEDESTRIAN = 16u };
     enum { T_LIGHT_AHEAD = 17u };
     enum { DUCK_CROSSING = 18u };
